...
class SPRVLAPreprocessorConfig(BaseConfig):
    ...
    def get_image_padding_lens(self, vision_backbone_config: SPRVLAVisionBackboneConfig):
    ...
    def build(self, tokenizer, vision_backbone_config: SPRVLAVisionBackboneConfig, max_seq_len):
        vit = vision_backbone_config.vit
        return SPRVLAPreprocessor(
            tokenizer=tokenizer,
...
@dataclasses.dataclass
class SPRVLAPreprocessor(InterleavedTextPreprocessor, ImagePreprocessor):
    """
...
class Preprocessor:
    ...
    mm_preprocessor: SPRVLAPreprocessor
