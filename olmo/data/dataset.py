...
if "SPRVLA_DATA_DIR" in os.environ:
    DATA_HOME = join(os.environ["SPRVLA_DATA_DIR"], "torch_datasets")
else:
    warnings.warn("SPRVLA_DATA_DIR is not set, data loading might fail")
    DATA_HOME = None
