...
# This script loads in the data from the original format and processes it into a TFDS format needed for the SPRVLA pipeline.
# To use it:
...
class AndroidControlBuilder(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, processed_data):
        for row_id, data in enumerate(processed_data):
            ...
            answer = self.map_coordinates_msprvla(target_action, dims)
    ...
    def map_coordinates_msprvla(self, action, dims):
        W, H = dims
