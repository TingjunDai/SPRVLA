...
from olmo.models.sprvla.sprvla import SPRVLA, SPRVLAConfig
...
class ModelEvaluator:
    ...
    def initialize_and_load_model(self) -> SPRVLA:
        cfg = self.config
        ...
        if cfg.load_path == "debug":
            ...
            model_cfg = SPRVLAConfig(
                ...
                mm_preprocessor=SPRVLAPreprocessorConfig(crop_mode="resize")
            )
            ...
            if self.config.model:
                ...
                model_cfg = SPRVLAConfig.load(model_cfg_path, key="model", validate_paths=False)
            with torch.device("meta"):
                model: SPRVLA = model_cfg.build_model()
