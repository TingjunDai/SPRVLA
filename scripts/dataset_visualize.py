...
from olmo.models.sprvla.model_preprocessor import Preprocessor, SPRVLAPreprocessor
...
def main():
    parser = argparse.ArgumentParser(prog="Visualize a dataste used in SPRVLA")
